...
namespace Chat.V4 {
  ...
  #endif
  {
    ...
    public User(User other) : this() {
      id_ = other.id_;
      name_ = other.name_;
      serverPermissions_ = other.serverPermissions_.Clone();
    ...
    /// <summary>Field number for the "serverPermissions" field.</summary>
    public const int ServerPermissionsFieldNumber = 3;
    private static readonly pb::FieldCodec<global::Chat.V4.ServerPermission> _repeated_serverPermissions_codec
        = pb::FieldCodec.ForMessage(26, global::Chat.V4.ServerPermission.Parser);
    private readonly pbc::RepeatedField<global::Chat.V4.ServerPermission> serverPermissions_ = new pbc::RepeatedField<global::Chat.V4.ServerPermission>();
    /// <summary>
    /// Permissions of the user for servers
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<global::Chat.V4.ServerPermission> ServerPermissions {
      get { return serverPermissions_; }
    }
    ...
    public bool Equals(User other) {
      ...
      if(!serverPermissions_.Equals(other.serverPermissions_)) return false;
    ...
    public override int GetHashCode() {
      ...
      hash ^= serverPermissions_.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      serverPermissions_.WriteTo(output, _repeated_serverPermissions_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      serverPermissions_.WriteTo(ref output, _repeated_serverPermissions_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      size += serverPermissions_.CalculateSize(_repeated_serverPermissions_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(User other) {
      ...
      serverPermissions_.Add(other.serverPermissions_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 26: {
            serverPermissions_.AddEntriesFrom(input, _repeated_serverPermissions_codec);
            break;
          }
        }
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 26: {
            serverPermissions_.AddEntriesFrom(ref input, _repeated_serverPermissions_codec);
            break;
          }
        }
      }
  ...
  #endif
  {
    ...
    private global::Chat.V4.Server server_;
    /// <summary>
    /// Server where the channel is located
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Chat.V4.Server Server {
      get { return server_; }
      set {
        server_ = value;
      }
    ...
    public void MergeFrom(Channel other) {
      ...
      if (other.server_ != null) {
        if (server_ == null) {
          Server = new global::Chat.V4.Server();
        }
